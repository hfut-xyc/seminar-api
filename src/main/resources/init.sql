...
INSERT INTO `report`(title, speaker, time, location, cid, sid) VALUES ('从预训练人工神经网络构建脉冲神经网络', '顾实', '2021-04-23 10:00:00', '北京大学理科二号楼2735', 1, 3);
INSERT INTO `report`(title, speaker, time, location, cid, sid) VALUES ('认知动态系统新进展', '吴启晖教授', '2021-04-17 10:00:00', '同济大学电信楼117', 2, 2);
INSERT INTO `report`(title, speaker, time, location, cid, sid) VALUES ('面向未来移动通信的PCC极化码和IS-LDPC码', '江涛教授', '2021-04-27 10:00:00', '同济大学电信楼403', 2, 2);
INSERT INTO `report`(title, speaker, time, location, cid, sid) VALUES ('面向多峰值优化的进化计算方法研究', '詹志辉教授', '2021-04-28 16:00:00', '计算机学院E202会议室', 3, 2);
...
CREATE TABLE `user_city`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY idx_uid_cid(`uid`,`cid`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci;
...
CREATE TABLE `user_subject`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY idx_uid_sid(`uid`,`sid`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci;
...
CREATE TABLE `user_report`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY idx_uid_rid(`uid`,`rid`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci;
